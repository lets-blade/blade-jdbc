...
public class Pager<T> implements Serializable {
	...
	public Pager(long total, int pageNum){
		init(total, pageNum, this.limit);
	}
	
	public Pager(long total, int pageNum, int limit){
	...
	public String toString() {
		return "Pager [total=" + total + ", limit=" + limit + ", pages=" + pages + ", pageNum="
				+ pageNum + ", isFirstPage=" + isFirstPage + ", isLastPage=" + isLastPage + ", hasPrevPage="
				+ hasPrevPage + ", hasNextPage=" + hasNextPage + ", navPages=" + navPages + ", navPageNums="
				+ Arrays.toString(navPageNums) + "]";
	}
