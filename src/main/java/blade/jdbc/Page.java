...
public class Page<E> extends ArrayList<E> {
	 ...
	 * @return
	 */
	public Pager<E> toPageInfo() {
		Pager<E> pageInfo = new Pager<E>(this);
		return pageInfo;
	}
	 ...
	 * return (Page<E>) this; }
	 * 
	 * public <E> Pager<E> doSelectPageInfo(ISelect select) { select.doSelect();
	 * return (Pager<E>) this.toPageInfo(); }
	 * 
	 * public long doCount(ISelect select) { this.pageSizeZero = true;
	 * this.pageSize = 0; select.doSelect(); return this.total; }
	 */
